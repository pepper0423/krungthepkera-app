...
export default function login() {
    return (
        <>
            <div className="min-h-screen bg-green-600 py-6 flex flex-col justify-center sm:py-12">
                                ...
                                <form className="pt-6 pb-8 mb-4">
                                    ...
                                    <div className="mt-6 text-center">
                                        <div className="mx-auto">
                                            <button type="submit" className="bg-gray-500 hover:bg-gray-600 py-2 px-4 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-gray-400">เข้าสู่ระบบ</button>
                                        </div>
                                    </div>
                                </form>
