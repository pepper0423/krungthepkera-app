                            ...
                            <div className="divide-y divide-gray-200">
                                <form className="pt-6 pb-8 mb-4">
                                    ...
                                    <div className="mt-6 text-center">
                                        <button type="submit" className="bg-gray-500 hover:bg-gray-600 py-2 px-4 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-gray-400">สมัครสมาชิก</button>
                                    </div>
                                </form>
